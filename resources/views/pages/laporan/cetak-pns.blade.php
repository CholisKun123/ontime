...
<html>
    ...
    <body>
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="text-center">
                    <img src="{{ asset('/assets/img/dinassurabaya.png')}}" style="width:120px; height:120px;">
                </div>
            </div>
            <div class="col-md-6">
                <h3 class="text-center">DINAS PENDIDIKAN SURABAYA</h3>
                <h4 class="text-center">SMK 1 NEGERI SURABAYA</h4>
                <h5 class="text-center">Jalan Smea, Wonokromo, Kota Surabaya, Jawa Timur</h5>
            </div>
            <div class="col-md-2">
                <div class="text-center">
                    <img src="{{ asset('/assets/img/smk1n.jpeg')}}" style="width:120px; height:120px;">
                </div>
            </div>
            <div class="col-md-1"></div>
        </div>
        <hr>
        <br>
        <h2 class="text-center">LAPORAN ABSENSI GURU PNS</h2>
