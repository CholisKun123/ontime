...
@section('title', 'Absensi Guru PNS')
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-detail">
                                ...
                                <ul>
                                    ...
                                    <li>Absensi akan dinyatakan terlambat jika melewati pukul 08.15 pagi</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 pl-md-0">
                    <div class="card card-annoucement card-round">
                        <div class="card-header text-center bg-warning">
                            <div class="card-title text-center text-white">Fitur Tambahan</div>
                        </div>
                        <div class="card-body">
                            <h3 class="text-danger">Fitur ini digunakan untuk menyesuaikan koordinat guru dan sekolah agar absensi bisa dilakukan.</h3>
                            <div class="row mt-5">
                                <div class="col-md-6">
